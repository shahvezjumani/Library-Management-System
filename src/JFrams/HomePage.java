...
public class HomePage extends javax.swing.JFrame {
    ...
    */
    ...
    private void initComponents() {
        ...
        table1.setColorBackgoundHead(new java.awt.Color(0, 0, 102));
        table1.setColorFilasBackgound2(new java.awt.Color(255, 255, 255));
        table1.setColorSelBackgound(new java.awt.Color(255, 204, 51));
        table1.setColorSelForeground(new java.awt.Color(0, 0, 0));
        table1.setFont(new java.awt.Font("Segoe Print", 1, 15)); // NOI18N
        table1.setFuenteFilas(new java.awt.Font("SimSun", 1, 16)); // NOI18N
        table1.setFuenteFilasSelect(new java.awt.Font("Tempus Sans ITC", 1, 19)); // NOI18N
        table1.setFuenteHead(new java.awt.Font("Tempus Sans ITC", 1, 18)); // NOI18N
        table1.setMaximumSize(new java.awt.Dimension(700, 60));
        ...
        if (table1.getColumnModel().getColumnCount() > 0) {
            ...
            table1.getColumnModel().getColumn(3).setMinWidth(400);
            table1.getColumnModel().getColumn(3).setMaxWidth(400);
        }

        jPanel10.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 270, 830, 160));
        ...
        table2.setColorBackgoundHead(new java.awt.Color(0, 0, 102));
        table2.setColorFilasBackgound2(new java.awt.Color(255, 255, 255));
        table2.setColorSelBackgound(new java.awt.Color(255, 204, 51));
        table2.setColorSelForeground(new java.awt.Color(0, 0, 0));
        table2.setFont(new java.awt.Font("Segoe Print", 1, 15)); // NOI18N
        table2.setFuenteFilas(new java.awt.Font("SimSun", 1, 16)); // NOI18N
        table2.setFuenteFilasSelect(new java.awt.Font("Tempus Sans ITC", 1, 19)); // NOI18N
        table2.setFuenteHead(new java.awt.Font("Tempus Sans ITC", 1, 18)); // NOI18N
        table2.setMaximumSize(new java.awt.Dimension(700, 60));
        ...
        if (table2.getColumnModel().getColumnCount() > 0) {
            ...
            table2.getColumnModel().getColumn(1).setMinWidth(400);
            table2.getColumnModel().getColumn(1).setMaxWidth(400);
            table2.getColumnModel().getColumn(2).setMinWidth(220);
            table2.getColumnModel().getColumn(2).setMaxWidth(220);
            table2.getColumnModel().getColumn(3).setMinWidth(80);
            table2.getColumnModel().getColumn(3).setMaxWidth(80);
        }

        jPanel10.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 490, 780, 160));
